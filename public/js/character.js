...
.sw-bowtie{top:7px;left:50%;width:26px;height:12px;transform:translateX(-50%);}
...
.sw-racecar{left:50%;bottom:10px;width:150px;height:84px;opacity:var(--car-opacity);transform:translate(calc(-50% + var(--car-shift-x)),var(--car-shift-y)) scale(var(--car-scale));transform-origin:center bottom;z-index:1;}
...
.steward-dog-svg{position:absolute;left:-8px;bottom:32px;width:62px;height:72px;opacity:var(--dog-opacity);transform:translate(var(--dog-shift-x),var(--dog-shift-y)) scale(var(--dog-scale));transform-origin:left bottom;z-index:4;pointer-events:none;transition:opacity 0.3s ease,transform 0.3s ease;}
.steward-wrap[data-state="wealthy"] .steward-dog-svg{opacity:var(--dog-opacity);}
...
.steward-wrap[data-state="building"]::before{background:linear-gradient(180deg,var(--capsule-fill-top) 0%,var(--capsule-fill-bottom) 68%,rgba(255,255,255,0.02) 100%),radial-gradient(circle at 50% 40%,rgba(65,190,108,0.44),transparent 62%),radial-gradient(circle at 50% 100%,rgba(16,41,32,0.14),transparent 52%);}
@keyframes thriveAuraPulse{0%,100%{opacity:0.82;transform:scale(1);}50%{opacity:1;transform:scale(1.05);}}
.steward-wrap[data-state="thriving"]::before{background:linear-gradient(180deg,var(--capsule-fill-top) 0%,var(--capsule-fill-bottom) 68%,rgba(255,255,255,0.02) 100%),radial-gradient(circle at 50% 38%,rgba(42,210,128,0.58),transparent 62%),radial-gradient(circle at 50% 100%,rgba(16,41,32,0.14),transparent 52%);animation:thriveAuraPulse 1.9s ease-in-out infinite;}
.steward-wrap[data-state="thriving"]::after{content:"";position:absolute;left:5px;right:5px;top:-5px;bottom:-2px;border-radius:44px;border:1.5px solid rgba(72,218,142,0.40);pointer-events:none;z-index:0;animation:thriveHalo 1.9s ease-in-out infinite;}
...
.wealthy-mansion,.wealthy-merc{opacity:0;pointer-events:none;transition:opacity 0.3s ease;}
.steward-wrap[data-state="wealthy"] .wealthy-mansion{opacity:0;filter:blur(0.5px) contrast(0.90) brightness(0.96);}
