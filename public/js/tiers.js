...
export const TIER_FLOW = [
  ...
  { id: 'broke',       badge: '02', label: 'Pushing',     phase: 'Pressure',   cue: 'Hold the line. No backsliding.',            accent: '#b18f7a', soft: 'rgba(177,143,122,0.18)', strong: '#8d6b56', start: '#f3c59b', end: '#b87442', fill: 'rgba(177,116,66,0.20)', line: 'rgba(199,132,78,0.88)' },
  { id: 'struggling',  badge: '03', label: 'Struggling',  phase: 'Pressure',   cue: 'Net is down \u2014 keep paying.',           accent: '#cf8d7d', soft: 'rgba(207,141,125,0.18)', strong: '#af6f5f', start: '#f6c3a8', end: '#cc7d61', fill: 'rgba(191,111,91,0.20)', line: 'rgba(214,129,105,0.88)' },
  { id: 'surviving',   badge: '04', label: 'Surviving',   phase: 'Momentum',   cue: 'Mid-climb. Don\u2019t ease pressure.',      accent: '#c7a15f', soft: 'rgba(199,161,95,0.18)', strong: '#a37e38', start: '#f8d48d', end: '#c79a3a', fill: 'rgba(199,154,58,0.20)', line: 'rgba(213,171,82,0.88)' },
  { id: 'stabilizing', badge: '05', label: 'Stabilizing', phase: 'Momentum',   cue: 'Keep doing what works.',                   accent: '#8db86f', soft: 'rgba(141,184,111,0.18)', strong: '#67934a', start: '#cbe7a8', end: '#79b557', fill: 'rgba(111,163,76,0.20)', line: 'rgba(129,188,87,0.88)' },
  { id: 'stable',      badge: '06', label: 'Stable',      phase: 'Momentum',   cue: 'It\u2019s working. Stay on it.',           accent: '#68bf7d', soft: 'rgba(104,191,125,0.18)', strong: '#389560', start: '#9be2ad', end: '#38b76d', fill: 'rgba(56,151,96,0.20)', line: 'rgba(74,190,114,0.88)' },
  { id: 'building',    badge: '07', label: 'Breaking', phase: 'Final Push', cue: 'Habits set here \u2014 stack payments.',    accent: '#4d86c7', soft: 'rgba(77,134,199,0.18)', strong: '#2d67aa', start: '#93c7ff', end: '#3b86e4', fill: 'rgba(53,116,196,0.18)', line: 'rgba(77,146,224,0.88)' },
  ...
  { id: 'winning',     badge: '09', label: 'Finish',   phase: 'Final Push', cue: 'Last miles. Don\u2019t drift.',             accent: '#d2b249', soft: 'rgba(210,178,73,0.20)', strong: '#b68a1f', start: '#ffe38f', end: '#d6ad34', fill: 'rgba(189,146,34,0.22)', line: 'rgba(221,188,72,0.92)' },
